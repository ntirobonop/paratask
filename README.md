...
Versions `v0.1.0` through `v0.5.0` provide a persistent offline Inbox, Quick Add, completion with Undo, editable Task Details, Today, Upcoming, and project management. Development is currently focused on `v0.6`: project sections, grouped task lists, section-aware task creation, and consistent project identity outside project screens.
